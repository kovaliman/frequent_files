...
class GenerateUpdateValidationTest extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:update-validation-test';
    ...
    {
        return __DIR__ . '/Stubs/tests/DummyUpdateValidationTest.stub';
    }

...
class GenerateGetTest extends GeneratorCommand
{
    /**
    ...
    {
        return __DIR__ . '/Stubs/tests/DummyGetByIdTest.stub';
    }
    ...
    protected function replaceClass($stub, $name)
    {
        ...
        return str_replace('DummyGetByIdTest', $this->argument('name'), $stub);
    }
